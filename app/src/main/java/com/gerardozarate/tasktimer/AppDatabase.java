...
class AppDatabase extends SQLiteOpenHelper{
    ...
    /**
     *
     * Get an instance of the app's singleton database hellper object
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        switch(oldVersion){
            case 1:
                //Upgrade login from version 1
                break;
            default: 
                throw new IllegalStateException("onUpgrade() with unknown newVerwion: " + newVersion);
        }
